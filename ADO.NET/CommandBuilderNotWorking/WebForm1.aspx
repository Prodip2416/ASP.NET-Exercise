<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="CommandBuilderNotWorking.WebForm1" %>
    ...
    <table border="2" >
        ...
        <table>
            <tr>
                <td><b>Insert</b></td>
                <td>
                    <asp:Label ID="lblInsert" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td><b>Update</b></td>
                <td>
